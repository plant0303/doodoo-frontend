        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-400 max-w-sm">
              doodoo is a free stock image platform offering high-resolution, high-quality photos for commercial use. All images can be freely downloaded, used, and modified.
            </p>
